...
<div class="container">
    ...
    <form method="POST" action="{{ route('estudiantes.update', ['estudiantes' => $estudiante->id]) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" required class="form-control" id="name" placeholder="Nombre estudiante"
                   name="name" value="{{ $estudiante->name }}">
        </div>

        <div class="mb-3">
            <label for="apellido" class="form-label">Apellido</label>
            <input type="text" required class="form-control" id="apellido" placeholder="Apellido estudiante"
        ...
        <div class="mb-3">
            ...
            <input type="date" required class="form-control" id="fecha_nacimiento"
                   name="fecha_nacimiento" value="{{ $estudiante->fecha_nacimiento }}">
        </div>
